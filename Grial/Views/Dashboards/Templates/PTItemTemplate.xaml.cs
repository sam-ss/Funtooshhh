...
{
	public partial class PTItemTemplate : ContentView
	{
		...
		public async void OnWidgetTapped(object sender, EventArgs e)
		{
			...
			try{
				...
				await PricingCalculatorDetailSelection.NavigateToCategory ((SampleCategory)BindingContext, Navigation);
			}finally{
